...
class EmotionModelTransformer:
    ...
    # Update the reduce_to_quadrant_emotions method
    def reduce_to_quadrant_emotions(self):
        # Use the DBDriver to update the database based on valence and arousal values
        update_query = """
        ...
        # Print a message indicating the reduction is complete
    ...
    def reduce_emotions(self, mapping):
        ...
        # Extract unique source_emotion values from the DataFrame
        unique_source_emotions = data['source_emotion'].unique()

        # Check if all unique source_emotions are in the mapping keys
        ...
        # Iterate over the mapping and update the database
        ...
        # Print a message indicating the transformation is complete
    ...
    def transform_to_russell(self, mapping):
        ...
        # Use the DBDriver to update the database for each key in the mapping
    ...
    def show_statistics(self):
        # use the dbDriver to retrieve data from the database
        data = self.db_driver.get_all_rows_as_dataframe()
        ...
        # Create a PrettyTable instance to display the statistics
        table = PrettyTable()
